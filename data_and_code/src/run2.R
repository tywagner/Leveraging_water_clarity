...
###
### This script performs the analysis for the 2nd holdout set, (random75)
...
sub.data <- subsetData(lake.data.180627)[[2]] 
...
run2 <- drive.lakes(data, pars, priors, 2000, 1000) 
saveRDS(run2, file = "./data/run2_180627.rds")				
...
pred2 <- predict.all(run2, 200, 2000, 1800)	
saveRDS(pred2, file = "./data/pred2_180627.rds")			

# predict nutrient responses, conditional on secchi
pred2.cond <- predict.cond(run2, 200, 2000, 1800)
saveRDS(pred2.cond, file = "./data/pred2_cond_180627.rds")
